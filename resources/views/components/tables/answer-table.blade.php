...
<div class="h-full w-75 border-bottom border-primary p-4 bg-white">
        ...
        <div class="row justify-content-between">
            ...
            <div class="col-1">
                <div class="badge bg-light text-warning">
                    ...
                    <span class="badge bg-dark">3.2</span>
                </div>
    ...
    <div class="row mt-3 justify content-between">
        ...
        <div class="col-1">
            <button type="button" class="open-modal btn btn-outline-dark border-secondary mt-4" data-useranswerid="{{ $answer->user_id }}" data-logid="{{ Auth::user()->id }}"
                data-answerid="{{ $answer->id }}"   data-bs-target="#modal-rate-{{ $answer->id }}">
                Valuta
            </button>
        </div>
    </div>
